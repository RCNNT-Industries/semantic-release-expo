 ...
 */
export function getManifestFiles(config) {
 ...
 */
export function getVersionTemplates(config) {
 ...
 */
export function getPrepareConfig(context) {
 ...
 */
export function inheritPrepareConfig(config, context) {
